...
export default function Todos(){
    // https://task-master-api-five.vercel.app/user/gettodos (GET)
    // https://task-master-api-five.vercel.app/user/markasdone?todoid=${todoid}`
    ...
    const markAsCompleted = (todoid)=>{
        const markTodoCompleted = async()=>{
            const response  =await fetch(`https://task-master-api-five.vercel.app/user/markasdone?todoid=${todoid}`,{
                method : 'POST',
                headers : {
                    'Content-Type' : 'application/json',
                    authorization : 'Bearer ' + JSON.parse(localStorage.getItem('token'))
    ...
    const removeTodo = async(todoid)=>{
        const response = await fetch(`https://task-master-api-five.vercel.app/user/removetodo?todoid=${todoid}`,{
            method  : 'DELETE',
            headers : {
                'Content-Type' : 'application/json',
                authorization  : 'Bearer ' + JSON.parse(localStorage.getItem('token'))
